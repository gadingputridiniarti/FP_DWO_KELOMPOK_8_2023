...
<html lang="en">
    ...
    <body id="page-top">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-900">Production</h1>
                        </div>
                                ...
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col auto">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total kuantitas barang yang diproduksi pada Tahun 2003</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                                                        $mysqli = mysqli_connect("localhost","root","","uas_kelompok8");
                                                        $sql = "SELECT SUM(sf.Quantity) total, t.tahun FROM fakta_production sf JOIN time t ON sf.time_id = t.time_id WHERE t.tahun=2003;";
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Production</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="card shadow mb-4">
                                    ...
                                    <div
                                        ...
                                        <h6 class="m-0 font-weight-bold text-dark">Trend Pendapatan Produksi Setiap Bulan</h6>
                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="card shadow mb-4">
                                    ...
                                    <div
                                        class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-dark">Pendapatan Per Tahun</h6>
                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body-store">
                                        <div class="chart-area-store">
                                            ...
                                            <?php
                                                ...
                                                $tahun = mysqli_query($mysqli,"SELECT DISTINCT(t.tahun) as tahun FROM sales_fact sf JOIN time t on t.time_id = sf.time_id");
                                                while($row = mysqli_fetch_array($tahun)){
                                                    $jenis_tahun[] = $row['tahun'];

                                                    $query = mysqli_query($mysqli,"SELECT SUM(sf.sub_total) as amount FROM sales_fact sf JOIN time t ON sf.time_id = t.time_id WHERE t.tahun='".$row['tahun']."'");
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-dark">Trend Jumlah Kuantitas Produksi Setiap Tahun</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="chart-area">
        ...
        <script type="text/javascript">
            ...
            $year = "SELECT DISTINCT(t.tahun) as year FROM fakta_production sf JOIN time t on t.time_id = sf.time_id";
            $amount = "SELECT SUM(sf.OrderQty) as amount FROM fakta_production sf JOIN time t ON sf.time_id = t.time_id GROUP BY t.tahun";
            $i=1;
        ...
        <script type="text/javascript">
            ...
            $amount1 = "SELECT SUM(sf.sub_total) as amount FROM sales_fact sf JOIN time t ON sf.time_id = t.time_id WHERE t.tahun=2004 GROUP BY t.bulan";
            $amount2 = "SELECT SUM(sf.sub_total) as amount FROM sales_fact sf JOIN time t ON sf.time_id = t.time_id WHERE t.tahun=2003 GROUP BY t.bulan";
            $amount3 = "SELECT SUM(sf.sub_total) as amount FROM sales_fact sf JOIN time t ON sf.time_id = t.time_id WHERE t.tahun=2002 GROUP BY t.bulan";
            $i=1;
        ...
        <script type="text/javascript">
            ...
            $conn= mysqli_connect($host, $user, $password, $database);
            $year = "SELECT DISTINCT(t.tahun) as year FROM fakta_production sf JOIN time t on t.time_id = sf.time_id";
            $amount1= "SELECT SUM(sf.OrderQty) as amountqty FROM fakta_production sf JOIN time t ON sf.time_id = t.time_id GROUP BY t.tahun";
            $i=1;
            $query_year=mysqli_query($conn, $year);
            $jumlah_year = mysqli_num_rows($query_year);
            $chart_year="";
            ...
            data: {
                labels: [<?php echo $chart_year; ?>],
                datasets: [{
                label: "Total Kuantitas Produksi",
                lineTension: 0.3,
                backgroundColor: "rgba(78, 115, 223, 0.05)",
                borderColor: "rgba(78, 115, 223, 1)",
                pointRadius: 3,
