        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Due</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                <?php
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                <?php
                                                    $sql = "SELECT COUNT(ProductID) as jumlah_produksi from fakta_production";
                                                    $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                    ...
                    <div class="card-body">
                    <button class="my-button " onclick="window.location.href='home.php'">Kembali</button>

                        <iframe name="mondrian" src="http://localhost:8080/mondrian/testpage.jsp?query=purchasing" style="height: 500px;; width:100%; border:none; align-content:center"> 
                        </iframe>
                    </div>
                </div>
                <!-- End of Page Content -->
